...
const fullConsentText = `Apha Health Plan is a privately owned Medicare guidance website and is not affiliated with, endorsed by, or operated by Medicare, the Centers for Medicare & Medicaid Services (CMS), Healthcare.gov, or any federal or state government agency. We do not offer every plan available in your area. By clicking "Send my consultation request" or calling the number listed on this page, you agree that Apha Health Plan, a licensed insurance agent, insurance agency, or insurance company may contact you by phone, text message, or email at the contact information you provide, including through automated technology where permitted by law, to discuss Medicare Advantage, Medicare Supplement Insurance, or Prescription Drug Plan options. Your consent is not a condition of purchase. Message and data rates may apply. You may revoke consent at any time. For complete Medicare information, visit Medicare.gov, call 1-800-MEDICARE (TTY: 1-877-486-2048), or contact your local State Health Insurance Assistance Program (SHIP). The purpose of this communication is the solicitation of insurance.`;
    ...
    '@graph': [
      {
        ...
        email: 'hello@aphahealthplan.com',
        address: {
          '@type': 'PostalAddress',
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setSubmissionAlert({
        ...
        message:
          'Thank you for choosing Apha Health Plan. A licensed insurance specialist may contact you shortly to review your available coverage options and answer any questions.',
        variant: 'success',
      });
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-12 border-t border-[#dcebed] pt-8">
            <p className="text-xs leading-6 text-[#6a828d]">
              &copy; 2026 Apha Health Plan. All rights reserved. Apha Health Plan is a privately owned, non-government website and is not connected with or endorsed by Medicare, CMS, Healthcare.gov, or any government agency. Plan information and availability vary by area, carrier, eligibility, and enrollment period.
            </p>
          </div>
        </div>
      </footer>
