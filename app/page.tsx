          ...
          <div className="mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-[1.02fr_0.98fr]">
            ...
            <AnimatedPanel className="relative min-h-[620px] lg:min-h-[680px]">
              ...
              <div className="absolute bottom-16 right-0 z-30 w-72 rounded-[2rem] border border-white/90 bg-white/85 p-5 shadow-[0_28px_80px_rgba(8,32,51,0.14)] backdrop-blur-xl">
                ...
                <p className="mt-4 text-sm font-bold leading-6 text-[#082033]">Legal teams use Alpha to organize accident calls, verify details, and move qualified prospects into attorney review.</p>
              </div>
            </AnimatedPanel>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-7xl overflow-hidden rounded-[3rem] bg-[#082033] p-8 shadow-[0_38px_100px_rgba(6,42,60,0.22)] sm:p-12 lg:p-16">
            <div className="grid items-center gap-10 lg:grid-cols-[1fr_auto]">
              <div>
                ...
                <p className="mt-5 max-w-2xl text-lg leading-8 text-[#c6d9df]">Request a consultation and move forward with verified MVA leads, live transfers, and intake support organized around your firm’s criteria.</p>
              </div>
              <a
                href="#consultation"
      ...
      <footer className="relative z-10 border-t border-[#dcebed] bg-white/75 px-4 py-14 backdrop-blur sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr_0.8fr]">
            <div>
              <BrandMark />
              <p className="mt-6 max-w-md leading-7 text-[#5e7280]">Alpha Legal Intake helps personal injury law firms grow with Motor Vehicle Accident leads, live transfer calls, accident verification, case qualification, and legal call center support.</p>
            </div>
            <div>
